...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css proizvoda/posteljineSaDugmetom.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.0/css/all.css" integrity="sha384-lKuwvrZot6UHsBSfcMvOkWwlCMgc0TaWr+30HWe3a4ltaBwTZhyTEggF5tJv8tbt" crossorigin="anonymous">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <script type="text/javascript" src="Javascript proizvoda/posteljinaSaDugmetom.js"></script>
...
<body countextmenu="false">
    ...
    <header id="showcase" class="grid">
         <a href="PosteljineSaDugmetom.php?out=true"><i class="fas fa-sign-in-alt"></i></a> <!-- logout ikonica -->
        <div id="trakica">
    ...
    <ul class="navTekst">
        ...
        <a href="../index.php"><li>Kontakt</li></a> 
            ...
            <form action="../pomocneSkripte/uploadImage.php" method="post" enctype="multipart/form-data">
                Odaberite sliku:
                <input type='hidden' name='where' value='Posteljine'>
                <input type="file" class="btn" name="fileToUpload" id="fileToUpload" style="width: 90px;">
                <input type="submit" class="btn" value="Dodaj sliku" name="submit" style="height:49px;">
            </form>
        <div class="naslov">
            <h1>Posteljine</h1>
        </div>
          <a href="#trakica"><i class="fas fa-chevron-circle-up"></a></i> <!-- strelica za gore -->
            <div class="galerija">
            <?php
                $dir = 'Galerija proizvoda/Posteljine/';
                $files = glob($dir.'*.*');
                $lastImeage = null;
                foreach ($files as $i) {
                    echo '<img src="'.$i.'"/>';
