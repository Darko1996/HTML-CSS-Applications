...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css proizvoda/Carsafi.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.0/css/all.css" integrity="sha384-lKuwvrZot6UHsBSfcMvOkWwlCMgc0TaWr+30HWe3a4ltaBwTZhyTEggF5tJv8tbt" crossorigin="anonymous">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <script type="text/javascript" src="Javascript proizvoda/Carsafi.js"></script>
...
<body>
    ...
    <header id="showcase" class="grid">
         <a href="Login.php?from=Carsafi"><i class="fas fa-sign-in-alt"></i></a> <!-- login ikonica -->
        <div id="trakica">
