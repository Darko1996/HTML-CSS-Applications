...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css proizvoda/CarsafiSaDugmetom.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.0/css/all.css" integrity="sha384-lKuwvrZot6UHsBSfcMvOkWwlCMgc0TaWr+30HWe3a4ltaBwTZhyTEggF5tJv8tbt" crossorigin="anonymous">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <script type="text/javascript" src="Javascript proizvoda/CarsafiSaDugmetom.js"></script>
...
<body countextmenu="false">
    ...
    <header id="showcase" class="grid">
         <a href="CarsafiSaDugmetom.php?out=true"><i class="fas fa-sign-in-alt"></i></a> <!-- logout ikonica -->
        <div id="trakica">
       ...
       <a href="../index.php"><li>O nama</li></a> 
        ...
        <a href="../index.php"><li>Kontakt</li></a> 
            ...
            <form action="../pomocneSkripte/uploadImage.php" method="post" enctype="multipart/form-data">
                Odaberite sliku:
                <input type='hidden' name='where' value='Carsafi'>
            ...
            <!-- <button class="btn">Dodaj sliku</button> -->
          ...
          <a href="#trakica"><i class="fas fa-chevron-circle-up"></a></i> <!-- strelica za gore -->
            <div class="galerija">
            <?php
                $dir = 'Galerija proizvoda/Carsafi/';
                $files = glob($dir.'*.*');
                $lastImeage = null;
                foreach ($files as $i) {
                    echo '<img src="'.$i.'"/>';
