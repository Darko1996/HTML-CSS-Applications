...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css proizvoda/PeskiriSaDugmetom.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.0/css/all.css" integrity="sha384-lKuwvrZot6UHsBSfcMvOkWwlCMgc0TaWr+30HWe3a4ltaBwTZhyTEggF5tJv8tbt" crossorigin="anonymous">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <script type="text/javascript" src="Javascript proizvoda/PeskiriSaDugmetom.js"></script>
...
<body countextmenu="false">
    ...
    <header id="showcase" class="grid">
         <a href="PeskiriSaDugmetom.php?out=true"><i class="fas fa-sign-in-alt"></i></a> <!-- logout ikonica -->
        <div id="trakica">
    ...
    <ul class="navTekst">
        ...
        <a href="../index.php"><li>Kontakt</li></a> 
            ...
            <form action="../pomocneSkripte/uploadImage.php" method="post" enctype="multipart/form-data">
                Odaberite sliku:
                <input type='hidden' name='where' value='Peskiri'>
        ...
        <div class="naslov">
          ...
          <a href="#trakica"><i class="fas fa-chevron-circle-up"></a></i> <!-- strelica za gore -->
            <div class="galerija">
            <?php
                $dir = 'Galerija proizvoda/Peskiri/';
                $files = glob($dir.'*.*');
                $lastImeage = null;
                foreach ($files as $i) {
                    echo '<img src="'.$i.'"/>';
