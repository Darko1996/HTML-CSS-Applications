...
<meta charset="utf-8">
    ...
    <meta name="keywords" content="installment loan, Houston, installment loan Houston, installment in Houston, installment loan in Texas, quick cash Texas" />
    <title> Sommerall Installment Loans | Thank you</title>
    ...
    <nav class="navbar navbar-expand-xl navbar-light fixed-sticky" style="display: contents; ">
        <div class="container-fluid" style="padding: 0 100px; box-shadow: 0 0 12px black;">
            ...
            <picture data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
                    ...
                    <img src="../images/logo.png" alt="image" style="width: 300px">
            </picture>
            </a>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mr-auto text-center">
                                ...
                                <p class="address">16334 Summer Dawn Lane Houston TX 77095</p>
                            </div>
                        </div>
            ...
            <div class="row copyright">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p>
                            Copyright © Sommerall Installment Loans 2019. All Rights Reserved.
                            </p>
                        </div>
                    </div>
                </div>
