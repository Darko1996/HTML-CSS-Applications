...
<head>
    ...
    <title>The tire place of Jacksonville | About us</title>
...
<body>
    ...
    <div id="sadrzaj">
        <div data-aos="fade-down" class="strelica">
            <a href="#showcase"><i class="far fa-caret-square-up"></i></a><!-- strelica za gore -->
        </div>
        <div class="o-nama">
            <h4>About us</h4>
            <p>The company The tire place of Jaksonville exists over 20 years ago,
               reopened at the beginning of the year under new management.<br>
               Customers related.<br>
               Best price in the town and service quality guarantee.</p>
        </div>  
    </div>
